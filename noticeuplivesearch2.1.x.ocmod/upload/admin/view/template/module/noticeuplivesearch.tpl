    ...
    <div class="panel panel-default">
      ...
      <div class="panel-body">
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-information" class="form-horizontal">
          ...
          <div class="form-group">
           <label class="col-sm-2 control-label" for="findCategory"><?php echo $findCategory; ?></label>
           <div class="col-sm-10">
             <input value="1" <?php if($noticeuplivesearch_findCategory){ echo 'checked';} ?> type="checkbox" name="noticeuplivesearch_findCategory" class="form-control" id="findCategory">
           </div>
          </div>

          <div class="form-group">
           <label class="col-sm-2 control-label" for="findDescription"><?php echo $findDescription; ?></label>
           <div class="col-sm-10">
             <input value="1" <?php if($noticeuplivesearch_findDescription){ echo 'checked';} ?> type="checkbox" name="noticeuplivesearch_findDescription" class="form-control" id="findDescription">
           </div>
          </div>
