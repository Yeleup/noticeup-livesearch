<?php
class ControllerExtensionModuleNoticeuplivesearch extends Controller {
	private $error = array();

	public function index() {

		$language_array = $this->load->language('extension/module/noticeuplivesearch');
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validate()) {
			...
			$this->response->redirect($this->url->link('extension/module/noticeuplivesearch', 'user_token=' . $this->session->data['user_token'] . '&type=module', true));
		}
		...
		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->link('extension/module/noticeuplivesearch', 'user_token=' . $this->session->data['user_token'], true)
		);

		$data['action'] = $this->url->link('extension/module/noticeuplivesearch', 'user_token=' . $this->session->data['user_token'], true);
		...
		//$this->response->setOutput($this->load->view('extension/module/noticeuplivesearch.twig', $data));
		$this->response->setOutput($this->load->view('extension/module/noticeuplivesearch', $data));
		//$this->response->setOutput($this->load->view('extension/module/noticeupmultistore.tpl', $data));
	}

	protected function validate() {
		if (!$this->user->hasPermission('modify', 'extension/module/noticeuplivesearch')) {
