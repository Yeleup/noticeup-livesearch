...
class ControllerExtensionModuleNoticeuplivesearch extends Controller {
	...
	public function index() {
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validate()) {
			...
			$this->response->redirect($this->url->link('extension/module/noticeuplivesearch', 'token=' . $this->session->data['token'] . '&type=module', true));
		}
		...
		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->link('extension/module/noticeuplivesearch', 'token=' . $this->session->data['token'], true)
		);

		$data['action'] = $this->url->link('extension/module/noticeuplivesearch', 'token=' . $this->session->data['token'], true);
		...
		$this->response->setOutput($this->load->view('extension/module/noticeuplivesearch.tpl', $data));
